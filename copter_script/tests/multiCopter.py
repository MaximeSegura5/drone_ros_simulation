...
if __name__ == "__main__":
    ...
    while not drone1.z<0.1:
        time.sleep(1)
        print("test au sol")
    print("au sol")
    time.sleep(3)
    drone1.disconnect()
    drone2 = MyCopterHandler("drone2")
    drone2.enable_topics_for_read()
    print("copter2 initiated")
    drone2.connect("node2", rate=10)
