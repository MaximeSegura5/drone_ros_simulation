...
from TensorflowLiteClassification import TensorflowLiteClassificationModel
from TensorflowLiteDetection import TensorflowLiteDetectionModel
...
tflite_classification_model = "default"
...
class CopterHandler(RosHandler):
    def __init__(self,name):
        ...
        self.classification_model = TensorflowLiteClassificationModel("/home/administrator/copter_script/tensorflowlite_models/"+tflite_classification_model+"/model.tflite", "/home/administrator/copter_script/tensorflowlite_models/"+tflite_classification_model+"/labels.txt")
        self.detection_model = TensorflowLiteDetectionModel("/home/administrator/copter_script/tensorflowlite_models/"+tflite_detection_model+"/model.tflite", "/home/administrator/copter_script/tensorflowlite_models/"+tflite_detection_model+"/labels.txt")
    ...
    def update_parameters_from_topic(self):
        ...
        while True:
            if self.connected:
                ...
                #     if data!=None:
                #         self.last_detected_image = self.bridge.imgmsg_to_cv2(data, "rgb8")
                #         self.objects_detected = self.classification_model.run_from_cvimage(self.last_detected_image)
                ...
                if t-t1>self.recognition_rate:
                    ...
                    if data!=None:
                        self.last_detected_image = self.bridge.imgmsg_to_cv2(data, "rgb8")
                        self.objects_detected = self.detection_model.run_from_cvimage(self.last_detected_image)
                        #print(self.objects_detected)
